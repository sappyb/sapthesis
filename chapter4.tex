...
We conducted extensive simulation experiments using the
TraceR-CODES
...
%communications, our technique improves the performance by around XXXXXX\%.
%For the dynamic Milc benchmark where multiple patterns are
%performed in different iterations, our technique improves over
