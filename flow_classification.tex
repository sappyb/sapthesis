...
%Figure~\ref{fig:flow_schemes} shows the high-level view of flow classification
%in SDN-based HPC systems. 
%The components below SDN API are similar to
%traditional SDN systems, 
...
%\caption{Flow classification in SHS}
...
\subsection{Classifying flows with user input}
