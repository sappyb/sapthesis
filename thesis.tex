...
\title{Evaluating Network Parameters and SDN Strategies for Enhancing Performance in HPC Applications}
                                      %% Manuscript title
...
\degreeyear{2024}                     %% Graduation Year
\defensedate{May 5, 2024}             %% Date of Defense
...
\committeeperson{Fengfeng Ke}{University Representative}
