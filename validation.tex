%Before I analyze and learn from my simulation results, I will first present 
%my validation of the TraceR-CODES framework.
...
Figure~\ref{fig:validation} shows the results of the validation. On the
