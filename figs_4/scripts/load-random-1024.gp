...
set key top center vertical font ",30" outside
set key spacing 4
set lmargin 13.73
set rmargin 9.3
set bmargin 9.5
set offset 0.6,-0.4,0,0
set output "load-random-1024.eps"
#plot "load_new.dat" using 2:xtic(1) ti col fc rgb e, "" u 3 ti col fc rgb d,
plot 'load-random-1024.dat' using 2:xtic(1) lc rgb a ti "D-mod-k", '' using 3 lc rgb b ti "SDN routing"