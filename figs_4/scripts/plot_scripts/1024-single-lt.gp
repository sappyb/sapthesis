...
set output "1024-lt.eps"
plot "1024-single-pp-latency-speedup.dat" using 2:xtic(1) ti col fc rgb e, "" u 3 ti col fc rgb d,"" u 4 ti col fc rgb d, "" u 5 ti col fc rgb d
